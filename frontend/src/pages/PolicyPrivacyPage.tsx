                ...
                <section className="flex items-start flex-col justify-center gap-[50px]">
                    ...
                    <div className="">
                        ...
                        <p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
                            ...
                            <br /> 12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <Link to="/policy_privacy" className='underline'>https://myinspira.ru/policy_privacy</Link>
