...
import AboutMainScreen from "../components/AboutMainScreen";
import MakeFirstStep from "../components/MakeFirstStep";
...
const AboutLinguaSpace = lazy(() => import('../components/AboutLinguaSpace'));
...
export default function AboutUsPage() {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} transition={{ duration: 1 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="h-full relative overflow-x-hidden">
            ...
            <Suspense>
                <section className="bevealed-bottom-lingua h-[450px] mt-[70px] mb-[5px] mx:h-fit relative">
                    <AboutLinguaSpace />
                </section>
            </Suspense>
            ...
            <Suspense>
                <section className="bg-white pt-[60px] mt-[30px] l:mt-[50px] relative overflow-hidden z-[5]">
                    <Questions />
                </section>
            </Suspense>
